    ...
    describe('When accessing the data of authenticating user',() => {
        ...
        describe('Provide invalid password',() => {
            ...
            it('Should throw an error because we did not find user',async () => {
                await expect(
                    authenticationService.getAuthenticateUser('daniel.dang@contemi.com','danielne')
                ).rejects.toThrow();
            })
        })
        ...
        describe('Provide valid password',() => {
            ...
            describe('Found the user in the database',() => {
                ...
                it('Should return the user data',async () => {
                    const user = await authenticationService.getAuthenticateUser('daniel.dang@contemi.com','danielne')
